...
//  On one or more clicks on images, Reset button should appear with id="reset" and should disappear when it is clicked 
// let btn = document.createElement("button")
// btn.setAttribute("id","reset")
// btn.innerHTML="Reset"
// document.body.appendChild(btn)

//Image tags should have class with names: img1, img2, img3, img4 and img5. One of them should repeat as one image repeats. That means, identical images should have identical class-names.
...
//These classes have already been styled for you in style.css. Just give these class names to your images and images will be automatically rendered on them taken from an api.
// let images = document.querySelectorAll("img")//0 to 6 all images selected
// let k=0;//initialy value of k will be  0 
// for( let t of imgClass){
//     images[k++].setAttribute("class",t)//this loop will run k=0 will be k++,i.e. k=1, then again loop will run K++ then k=2 etc & t is class given to all images 
// }
